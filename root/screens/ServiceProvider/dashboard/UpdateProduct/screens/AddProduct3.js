...
export default function AddProduct3({navigation, ...props}) {
    ...
    console.log(props.route.params.params.service_address);
    const [form, setForm] = useState({
        service_address: {
            ...props.route.params.params.service_address,
            latitude: 0.0022,
            longitude: 0.0022,
        }
    })
    ...
    function handleContinue() {
        ...
        console.log(props.route.params.form.mediaID,"params");
console.log(Urls.AddService+`/${props.route.params.params.id}/`);
console.log(temp);
loading.show();
        fetch(Urls.AddService+`/${props.route.params.params.id}/`,{
            method:"PUT",
            headers:{
            ...
            console.log(res)
            if(res.id){
                 navigation.navigate("ServiceUpdated")
            }
            else{
...
function updateAddress(data) {
    ...
    return (
        <View style={[styles.container]}>
            ...
            <ButtonKdr style={{marginHorizontal:10,marginVertical:30}} text={"Update Service"} onPress={handleContinue}/>
        </View>
    )
}
